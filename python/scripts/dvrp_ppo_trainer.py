...
folder_name = "dynamic_vrp"  # the name of the folder where the json file is located
mdp_version_number = 0
path_to_json = dynaplex.filepath("mdp_config_examples", folder_name, f"mdp_configs/mdp_config_{mdp_version_number}.json")

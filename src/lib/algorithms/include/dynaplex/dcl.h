...
namespace DynaPlex::Algorithms {
	...
	{
	public:
		DCL(const DynaPlex::System& system, DynaPlex::MDP mdp, const DynaPlex::VarGroup& config = VarGroup{}, DynaPlex::Policy policy_0=nullptr);
	...
	private:
		...
		std::atomic<int64_t> total_samples_collected;
